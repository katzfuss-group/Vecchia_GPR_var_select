...
for(i in 1 : length(lambVec)){
  ...
  optObj <- fwd_bwd(idx = idx, theta = theta, sr0 = sr0, locsIn = locsIn, 
                    ...
                    stop_con_fb = stop_con_OOS0_fb, miniCQCD = NULL, 
...
lambStop <- lambVec[which(scrChg < 0.01)[1] + firstIdx - 1]
...
if(rho != 0){
  figFn <- paste0("QCCD_bridge_dep_", n, "_", d, ".pdf")
}else{
  figFn <- paste0("QCCD_bridge_", n, "_", d, ".pdf")
}
