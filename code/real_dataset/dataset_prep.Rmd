...
```{r read and rearrange cols, eval = T}
library(tidyverse)
trnXFn <- "../../data/temp_train.inputs_processed"
trnyFn <- "../../data/temp_train.targets_processed"
tstXFn <- "../../data/temp_valid.inputs_processed"
tstyFn <- "../../data/temp_valid.targets_processed"
dataLst <- map(list(trnXFn, trnyFn, tstXFn, tstyFn), 
            function(x){read.csv(x, header = F)})
```
