...
## Overview
Use the gradient w.r.t. SRs to select variables as in forward selection. The stopping criteria is BIC. `k` is the number of variables selected each time. Currently, `k` is set to one. 
