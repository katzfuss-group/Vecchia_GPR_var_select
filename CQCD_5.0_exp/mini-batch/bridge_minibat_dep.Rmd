...
save(list = c("d", "idxSet", "thetaSet", "scoreSet", "lambdaSet", "loglikSet",
              "lambdaVec", "n"), 
     file = paste0("bridge_minibat_dep_", n, "_", d, ".RData"))
```
...
ggsave(paste0("theta_minibat_dep_", n, "_", d, ".pdf"), width = 7, height = 5)
```
...
ggplot(data = dfScore, aes(x = lambda, y = score)) + 
  ...
  scale_y_continuous(trans = pseudo_log_trans(sigma = 0.1),
                     breaks = lambdaVec) +
  theme(legend.position = "none")
ggsave(paste0("score_minibat_dep_", n, "_", d, ".pdf"), width = 7, height = 5)
```
