...
## Method 
Maximin ordering and nearest neighbor conditioning not only with the previously selected predictors but also the newly selected predictors.
...
save(list = c("d", "idxSet", "thetaSet", "scoreSet", "lambdaSet", "loglikSet",
              "lambdaVec", "n"), 
     file = paste0("bridge_order_", n, "_", d, ".RData"))
```
...
ggsave(paste0("bridge_order_", n, "_", d, ".pdf"), width = 7, height = 5)
```
